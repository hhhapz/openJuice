...
export module std.os.unix.sys.platform.X86;
#else
export module stdlib.os.unix.sys.platform.X86;
#endif

/**
 * @namespace stdlib::os::posix::sys::platform
 * @brief Wrapper namespace for Unix POSIX operations.
 */
export namespace stdlib::os::posix::sys::platform {
    #ifdef __unix__
