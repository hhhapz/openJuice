 ...
 *
 * The HolyNight class implements both EventCard and StandardCard to represent the card "Holy Night" in the game.
 */
export class HolyNight final: public EventCard, public StandardCard {
private:
    static constexpr char CARD_KEY[] = "CARD_EVENT_HOLYNIGHT"; ///< The key belonging to the card to query in TextManager
...
public:
     ...
     */
    HolyNight():
        Card(CardType::EventCard, SpawnType::Standard, Rarity::Common, 17, 1, 1, 5) {}
