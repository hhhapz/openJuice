 ...
 *
 * The LittleWar class implements both EventCard and StandardCard to represent the card "Little War" in the game.
 */
export class LittleWar final: public EventCard, public StandardCard {
private:
    static constexpr char CARD_KEY[] = "CARD_EVENT_LITTLEWAR"; ///< The key belonging to the card to query in TextManager
...
public:
     ...
     */
    LittleWar():
        Card(CardType::EventCard, SpawnType::Standard, Rarity::Rare, 20, 4, 1, 2) {}
