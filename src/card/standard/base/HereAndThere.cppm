 ...
 *
 * The HereAndThere class implements both EventCard and StandardCard to represent the card "Here and There" in the game.
 */
export class HereAndThere final: public EventCard, public StandardCard {
private:
    static constexpr char CARD_KEY[] = "CARD_EVENT_HEREANDTHERE"; ///< The key belonging to the card to query in TextManager
...
public:
     ...
     */
    HereAndThere():
        Card(CardType::EventCard, SpawnType::Standard, Rarity::Common, 16, 2, 3, 0) {}
