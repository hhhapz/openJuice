 ...
 *
 * The FinalBattle class implements both BattleCard and StandardCard to represent the card "Final Battle" in the game.
 */
export class FinalBattle final: public BattleCard, public StandardCard {
private:
    static constexpr char CARD_KEY[] = "CARD_BATTLE_FINALBATTLE"; ///< The key belonging to the card to query in TextManager
...
public:
     ...
     */
    FinalBattle():
        Card(CardType::BattleCard, SpawnType::Standard, Rarity::Rare, 10, 4, 1, -2) {}
