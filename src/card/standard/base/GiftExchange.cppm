 ...
 *
 * The GiftExchange class implements both EventCard and StandardCard to represent the card "Gift Exchange" in the game.
 */
export class GiftExchange final: public EventCard, public StandardCard {
private:
    static constexpr char CARD_KEY[] = "CARD_EVENT_GIFTEXCHANGE"; ///< The key belonging to the card to query in TextManager
...
public:
     ...
     */
    GiftExchange():
        Card(CardType::EventCard, SpawnType::Standard, Rarity::Uncommon, 19, 3, 3, 0) {}
