 ...
 *
 * The SakisCookie class implements both BoostCard and StandardCard to represent the card "Saki's Cookie" in the game.
 */
export class SakisCookie final: public BoostCard, public StandardCard {
private:
    static constexpr char CARD_KEY[] = "CARD_BOOST_COOKIE"; ///< The key belonging to the card to query in TextManager
...
public:
     ...
     */
    SakisCookie():
        Card(CardType::BoostCard, SpawnType::Standard, Rarity::Common, 2, 1, 3, 0) {}
