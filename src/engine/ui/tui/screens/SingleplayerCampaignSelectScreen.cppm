...
export module engine.ui.tui.Screens:SingleplayerCampaignSelectScreen;
...
public:
     ...
     */
    SingleplayerCampaignSelectScreen(SharedPtr<Game> game, Function<void(ScreenType)> callback):
