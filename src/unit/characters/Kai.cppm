 ...
 * @extends Character
 *
 * The Kai class is a final class that inherits from Character and represents a specific character in the game.
 * Stats:
 * - ID: 1
 * - Health: 5
 * - Attack: 1
 ...
 * - Recovery: 5
 */
export class Kai final: public Character {
private:
    static constexpr inline char UNIT_KEY[] = "CARD_UNIT_KAI"; ///< The key belonging to the card to query in TextManager
    ...
    static constexpr inline char VOICEACTOR_KEY[] = "VOICEACTOR_MATSUURA_YOSHIYUKI"; ///< The key belonging to the name of the voice actor to query in TextManager
